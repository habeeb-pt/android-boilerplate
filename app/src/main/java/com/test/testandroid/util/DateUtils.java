...
public class DateUtils {
    ...
    /**
     * If the given time is of a different date, display the date. If it is of the
     * same date, display the time.
     * 
     ...
     * @return Whether {@param millisFirst} and {@param millisSecond} are off the
     *         same day.
     */
