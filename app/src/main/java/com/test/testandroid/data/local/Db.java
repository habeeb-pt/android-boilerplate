package com.test.testandroid.data.local;
...
import com.test.testandroid.data.model.Name;
import com.test.testandroid.data.model.TestProfile;
...
public class Db {
    ...
    public abstract static class RibotProfileTable {
        ...
        public static ContentValues toContentValues(TestProfile profile) {
        ...
        public static TestProfile parseCursor(Cursor cursor) {
