...
@AutoValue
public abstract class TestProfile implements Parcelable {
    ...
    public static Builder builder() {
        return new AutoValue_TestProfile.Builder();
    }

    public static TypeAdapter<TestProfile> typeAdapter(Gson gson) {
        return new AutoValue_TestProfile.GsonTypeAdapter(gson);
    }
    ...
    public abstract static class Builder {
        ...
        public abstract TestProfile build();
    }
}
