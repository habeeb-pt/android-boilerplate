...
public class HttpIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null) {
            ...
            // verifyOtp(otp);
            Timber.d("OTP to be verified" + otp);
        }
    }
    ...
    //
    // Intent intent = new Intent(HttpIntentService.this, DashboardActivity.class);
    ...
    // FliptangoApplication.getInstance().addToRequestQueue(strReq);
    // }
